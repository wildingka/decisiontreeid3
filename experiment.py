...
def run(data_path, learner_type, fraction):
    ...
    conf_matrix = confusion_matrix(test_targets, prediction)
    acc = accuracy(test_targets, prediction)
    prec, rec = precision_and_recall(test_targets, prediction)
    f1 = f1_measure(test_targets, prediction)
